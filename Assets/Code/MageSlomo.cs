...
public class MageSlomo : MonoBehaviour
{
    ...
    private void FreezeEnemies()
    {
        ...
        if (hits.Length > 0)
        {
            for (int i = 0; i < hits.Length; i++)
            {
                ...
                EnemyMovementSecondLevelAlt em = hit.transform.GetComponent<EnemyMovementSecondLevelAlt>();
                em.UpdateSpeed(0.5f);
    ...
    private IEnumerator ResetEnemySpeed (EnemyMovementSecondLevelAlt em)
    {
